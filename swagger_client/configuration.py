...
class Configuration(object):
    ...
    def __init__(self):
        ...
        # Default Base url
        self.host = "https://virtserver.swaggerhub.com/suryaharshan1/Tortoise/1.0.0"
            ...
            'tortoise_merchant_apiKey':
                {
                    ...
                    'in': 'header',
                    'key': 'X-TORTOISE-KEY',
                    'value': self.get_api_key_with_prefix('X-TORTOISE-KEY')
                },
            'tortoise_merchant_appId':
                {
                    ...
                    'in': 'header',
                    'key': 'X-TORTOISE-ID',
                    'value': self.get_api_key_with_prefix('X-TORTOISE-ID')
                },
